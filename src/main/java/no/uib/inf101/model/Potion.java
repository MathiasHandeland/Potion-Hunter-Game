     ...
     * The wizard should be able to pick up the potion by moving over it (collision detection).
    ...
    public class Potion implements IPotion {
        ...
        private int x, y; // Position of the potion on the game board 
        private int solidArea = 32; // Size of the potion
        private BufferedImage potion_sprite; // Image of the potion
        ...
        */
        ...
        /**
         * Gets the image of the potion.
         * Is used in the GameView class to draw the potion on the game board.
